        ...
        <div className="text-center">
          <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
            ...
            <span className="block text-blue-600">
                <img src="eSeniorLogo_trim.png" className="inline align-middle w-20 h-22 mb-1 mr-0 pr-0" alt="Blue-Tinted Image"/>
              <img src="minus.png" className="inline w-10 h-25 ml-0 pl-0" alt="Minus" />Senior</span>
          </h1>
